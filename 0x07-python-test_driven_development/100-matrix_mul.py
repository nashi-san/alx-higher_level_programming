...
def matrix_mul(m_a, m_b):
    ...
    if any(any(not isinstance(element, (int, float))) for element in row) for row in m_a:
    ...
    if any(any(not isinstance(element, (int, float)) for element in row) for row in m_b):
